...
{
public:
    cSoundEntry(const tString& asName, iSoundChannel* apSound, float afVolume, eSoundEntryType aType, bool ab3D, bool abStream, int alId, cSoundHandler* apSoundHandler);
    ~cSoundEntry();
...
public:
     ...
     * \return
     */
    cSoundEntry* Play(const tString& asName,
          bool abLoop,
          float afVolume,
    ...
    cSoundEntry* Play3D(const tString& asName,
          bool abLoop,
          float afVolume,
          const cVector3f& avPos,
          float afMinDist,
    ...
    cSoundEntry* PlayGuiStream(const tString& asFileName,
          bool abLoop,
          float afVolume,
    ...
    cSoundEntry* PlayGui(const tString& asName,
          bool abLoop,
          float afVolume,
          const cVector3f& avPos = cVector3f(0, 0, 1),
          eSoundEntryType aEntryType = eSoundEntryType_Gui,
    ...
    cSoundEntry* PlaySoundEntityGui(const tString& asName,
          bool abLoop,
          float afVolume,
          eSoundEntryType aEntryType = eSoundEntryType_Gui,
          const cVector3f& avPos = cVector3f(0, 0, 1),
