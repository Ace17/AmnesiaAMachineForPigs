...
public:
    iVertexBuffer(iLowLevelGraphics* apLowLevelGraphics,
        ...
        , mlReservedVtxSize(alReserveVtxSize)
        , mlReservedIdxSize(alReserveIdxSize)
        , mlElementNum(-1)
    {
    }
    ...
    virtual void CreateElementArray(eVertexBufferElement aType, eVertexBufferElementFormat aFormat, int alElementNum, int alProgramVarIndex = 0) = 0;
    ...
    virtual iVertexBuffer* CreateCopy(eVertexBufferType aType, eVertexBufferUsageType aUsageType, tVertexElementFlag alVtxToCopy) = 0;
