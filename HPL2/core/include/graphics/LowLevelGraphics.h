...
public:
     ...
     */
    virtual void SetVsyncActive(bool abX, bool abAdaptive) = 0;
     ...
     */
    virtual void CopyFrameBufferToTexure(iTexture* apTex, const cVector2l& avPos, const cVector2l& avSize, const cVector2l& avTexOffset = 0) = 0;
    ...
    virtual void SetStencilTwoSide(eStencilFunc aFrontFunc,
    ...
    virtual void DrawQuad(const cVector3f& avPos, const cVector2f& avSize, const cVector2f& avMinTexCoord, const cVector2f& avMaxTexCoord, const cColor& aColor = cColor(1, 1)) = 0;
    virtual void DrawQuad(const cVector3f& avPos,
