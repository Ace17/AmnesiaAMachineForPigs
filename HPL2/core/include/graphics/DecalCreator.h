...
private:
    ...
    bool AddPolygon(int alVertexCount,
    ...
    int ClipPolygon(int alVertexCount,
          const cVector3f* apVertices,
          const cVector3f* apNormals,
    ...
    int
    ClipPolygonAgainstPlane(const cPlanef& aPlane, int alVertexCount, const cVector3f* apVertices, const cVector3f* apNormals, cVector3f* apNewVertices, cVector3f* apNewNormals);
