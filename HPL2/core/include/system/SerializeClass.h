 ...
 */
#define kSerializeVar(aVar, aType) cSerializeMemberField(#aVar, ClassMemberOffset(tVarClass, aVar), ClassMemberSize(tVarClass, aVar), aType, eSerializeMainType_Variable),
 ...
 */
#define kSerializeVarContainer(aVar, aType) cSerializeMemberField(#aVar, ClassMemberOffset(tVarClass, aVar), ClassMemberSize(tVarClass, aVar), aType, eSerializeMainType_Container),
/**
...
{
public:
    cSerializeMemberField(const tString& asName, size_t alOffset, size_t alSize, eSerializeType alType, eSerializeMainType aMainType)
    {
        msName = asName;
        mlOffset = alOffset;
        mlSize = alSize;
    ...
    cSerializeMemberField(const tString& asName, size_t alOffset, size_t alSize, eSerializeType alType, eSerializeMainType aMainType, size_t alArraySize)
    {
        msName = asName;
        mlOffset = alOffset;
        mlSize = alSize;
    ...
    cSerializeMemberField(const tString& asName, size_t alOffset, size_t alSize, eSerializeType alType, eSerializeMainType aMainType, const tString& asClassName)
    {
        msName = asName;
        mlOffset = alOffset;
        mlSize = alSize;
...
public:
    ...
    cSerializeSavedClass(const char* asName, const char* asParent, cSerializeMemberField* apMemberFields, size_t alSize, iSerializable* (*apCreateFunc)());
...
{
public:
    cSerializeClass(const char* asName, const char* asParent, cSerializeMemberField* apMemberFields, size_t alSize, iSerializable* (*apCreateFunc)());
