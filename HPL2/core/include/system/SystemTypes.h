...
public:
    ...
    {
        if (seconds == aDate.seconds && minutes == aDate.minutes && hours == aDate.hours && month_day == aDate.month_day && month == aDate.month && year == aDate.year)
        {
            return true;
        }
    ...
    bool operator!=(const cDate& aDate) const { return !(*this == aDate); }
...
public:
    ...
    bool HasNext() { return mIt != mpCont->end(); }
