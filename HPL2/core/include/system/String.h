...
public:
    ...
    /**
     * Converts unicode to local encoding. (This can be ascii, utf-8 or strange things. This depends on platform and system setup. Keep in mind that that output might be utf-8
     * encoded. In any case, it is a format that things like printf, Log, etc likes, so okay to output.
     */
