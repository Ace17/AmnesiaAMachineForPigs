...
public:
    ...
    virtual void SetRawData(int alLevel, const cVector3l& avOffset, const cVector3l& avSize, ePixelFormat aPixelFormat, void* apData);
...
private:
    ...
    bool CopyTextureDataToGL(int alTextureHandle, int alLevel, unsigned char* apData, int alDataSize, const cVector3l avSize, ePixelFormat aPixelFormat, int alFaceNum);

    void GenerateMipMaps(GLenum aGLTarget, ePixelFormat aPixelFormat, const cVector3l avSize, unsigned char* apData, int alDataSize, int alFaceNum);
