...
struct cGamepadInputData
{
    cGamepadInputData()
        : mlPadIndex(0)
        , mInputType(eGamepadInputType_LastEnum)
        , mlInputId(0)
        , mfInputValue(0)
    {
    }
    ...
    {
        return mlPadIndex == aData.mlPadIndex && mInputType == aData.mInputType && mlInputId == aData.mlInputId && mfInputValue == aData.mfInputValue;
    }
