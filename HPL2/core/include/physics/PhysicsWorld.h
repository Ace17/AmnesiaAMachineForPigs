...
public:
    ...
    virtual void RenderShapeDebugGeometry(iCollideShape* apShape, const cMatrixf& a_mtxTransform, iLowLevelGraphics* apLowLevel, const cColor& aColor) = 0;

    virtual void RenderDebugGeometry(iLowLevelGraphics* apLowLevel, const cColor& aColor) = 0;

    virtual bool CheckShapeCollision(iCollideShape* apShapeA,
    ...
    bool CheckShapeWorldCollision(cVector3f* apPushVector,
          ...
          iPhysicsBody* apSkipBody = NULL,
          bool abSkipStatic = false,
          ...
          bool abDebug = false,
          bool abSkipStaticVolatile = false);
