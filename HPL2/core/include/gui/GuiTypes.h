...
struct cGuiMessageData
{
    ...
    cGuiMessageData(int alVal) { mlVal = alVal; }
    cGuiMessageData(float afVal) { mfVal = afVal; }
    cGuiMessageData(const cKeyPress& aKeyPress) { mKeyPress = aKeyPress; }
...
#define kGuiCallbackDeclarationEnd(FuncName) static bool FuncName##_static_gui(void* apObject, iWidget* apWidget, const cGuiMessageData& aData);

#define kGuiCallbackDeclaredFuncEnd(ThisClass, FuncName)                                                                                                                           \
    bool ThisClass::FuncName##_static_gui(void* apObject, iWidget* apWidget, const cGuiMessageData& aData) { return ((ThisClass*)apObject)->FuncName(apWidget, aData); }

#define kGuiCallbackFuncEnd(ThisClass, FuncName)                                                                                                                                   \
    static bool FuncName##_static_gui(void* apObject, iWidget* apWidget, const cGuiMessageData& aData) { return ((ThisClass*)apObject)->FuncName(apWidget, aData); }
