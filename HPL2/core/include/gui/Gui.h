...
public:
    ...
    void Init(cResources* apResources, cGraphics* apGraphics, cSound* apSound, cScene* apScene, cInput* apInput);
    ...
    cGuiGfxElement* CreateGfxTexture(const tString& asFile,
    ...
    cGuiGfxElement* CreateGfxTexture(iTexture* apTexture,
          bool abAutoDestroyTexture,
          eGuiMaterial aMaterial,
          const cColor& aColor = cColor(1, 1),
          bool abAddToList = true,
          const cVector2f& avStartUV = 0,
          const cVector2f& avEndUV = 1);

    /**
     * Loads several images asFile+00, etc. Used for animations.Must have extension!
     */
    cGuiGfxElement* CreateGfxImageBuffer(const tString& asFile,
          eGuiMaterial aMaterial,
