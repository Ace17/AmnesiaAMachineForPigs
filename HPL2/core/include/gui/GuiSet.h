...
public:
    ...
    void DrawGfx(cGuiGfxElement* apGfx,
          ...
          bool abUseCustomPivot = false,
          const cVector3f& avCustomPivot = 0);
    ...
    void DrawFont(iFontData* apFont, const cVector3f& avPos, const cVector2f& avSize, const cColor& aColor, eFontAlign aAlign, eGuiMaterial aMaterial, const wchar_t* fmt, ...);

    void DrawFont(iFontData* apFont, const cVector3f& avPos, const cVector2f& avSize, const cColor& aColor, const wchar_t* fmt, ...);
    ...
    cWidgetMainMenu* CreateWidgetMainMenu(iWidget* apParent = NULL, const tString& asName = "");
    ...
    cWidgetDummy* CreateWidgetDummy(const cVector3f& avLocalPos = 0, iWidget* apParent = NULL, const tString& asName = "");
    ...
    ////////////////////////////////////
    // Popup
    cGuiPopUpMessageBox* CreatePopUpMessageBox(const tWString& asLabel,
    ...
    cGuiPopUpFilePicker* CreatePopUpSaveFilePicker(tWString& asFileName,
          ...
          void* apCallbackObject,
          tGuiCallbackFunc apCallback,
          const tWString& asStartFilename = _W(""));

    cGuiPopUpFilePicker* CreatePopUpLoadFilePicker(tWStringVec& avFileList,
...
private:
    void DrawTextFromCharArry(const wchar_t* apString,
          iFontData* apFont,
          const cVector2f& avSize,
