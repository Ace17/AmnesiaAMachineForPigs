...
public:
    ...
    void SetSelectedItem(int alX, bool abMoveList = false, bool abGenerateCallback = true, eListBoxSelectType aType = eListBoxSelectType_Toggle, bool abClearPrevious = true);
    int GetSelectedItem();
