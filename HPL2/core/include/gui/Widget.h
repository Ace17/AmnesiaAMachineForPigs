...
public:
    ...
    virtual cGuiGlobalShortcut* AddShortcut(int alKeyModifiers,
          eKey aKey,
...
protected:
    ...
    void DrawDefaultText(const tWString& asText, const cVector3f& avPosition, eFontAlign aAlign, const cColor& aCol);

    void DrawDefaultTextHighlight(const tWString& asText, const cVector3f& avPosition, eFontAlign aAlign); //, int alFirstVisibleChar, int alHighlightStart, int alHighlightSize);
