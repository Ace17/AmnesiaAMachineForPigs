...
iSoundData* cLowLevelSoundFmod::LoadSoundData(const tString& asName, const tString& asFilePath, const tString& asType, bool abStream, bool abLoopStream)
{
...
void cLowLevelSoundFmod::SetListenerAttributes(const cVector3f& avPos, const cVector3f& avVel, const cVector3f& avForward, const cVector3f& avUp)
{
    ...
    m_mtxListener = cMatrixf(-mvListenerRight.x, -mvListenerRight.y, -mvListenerRight.z, avPos.x, -mvListenerUp.x, -mvListenerUp.y, -mvListenerUp.z, avPos.y, -mvListenerForward.x,
          -mvListenerForward.y, -mvListenerForward.z, avPos.z, 0, 0, 0, 1);

    float fVel[3] = { 0, 0, 0 };
    FSOUND_3D_Listener_SetAttributes(avPos.v, fVel, mvListenerForward.x, mvListenerForward.y, mvListenerForward.z, mvListenerUp.x, mvListenerUp.y, mvListenerUp.z);
}
...
void cLowLevelSoundFmod::SetListenerPosition(const cVector3f& avPos)
{
    ...
    FSOUND_3D_Listener_SetAttributes(avPos.v, mvListenerVelocity.v, mvListenerForward.x, mvListenerForward.y, mvListenerForward.z, mvListenerUp.x, mvListenerUp.y, mvListenerUp.z);
}
