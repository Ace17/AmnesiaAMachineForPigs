...
iSoundData* cLowLevelSoundOpenAL::LoadSoundData(const tString& asName, const tWString& asFilePath, const tString& asType, bool abStream, bool abLoopStream)
{
...
void cLowLevelSoundOpenAL::SetListenerAttributes(const cVector3f& avPos, const cVector3f& avVel, const cVector3f& avForward, const cVector3f& avUp)
{
...
void cLowLevelSoundOpenAL::Init(int alSoundDeviceID,
      bool abUseEnvAudio,
      int alMaxChannels,
