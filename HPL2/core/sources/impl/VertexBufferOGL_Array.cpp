...
void cVertexBufferOGL_Array::DrawIndices(unsigned int* apIndices, int alCount, eVertexBufferDrawType aDrawType)
{
    ;
...
iVertexBufferOpenGL* cVertexBufferOGL_Array::CreateDataCopy(tVertexElementFlag aFlags,
      eVertexBufferDrawType aDrawType,
      eVertexBufferUsageType aUsageType,
      int alReserveVtxSize,
      int alReserveIdxSize)
