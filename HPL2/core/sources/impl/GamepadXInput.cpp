...
cGamepadXInput::cGamepadXInput(int alIndex)
    : iGamepad("XInput Portable Gamepad", alIndex)
{
...
void cGamepadXInput::Update()
{
    ...
    if (lResult == ERROR_SUCCESS)
    {
        ...
        ///////////////////
        // Buttons
        size_t vButton[10] = { XINPUT_GAMEPAD_A, XINPUT_GAMEPAD_B, XINPUT_GAMEPAD_X, XINPUT_GAMEPAD_Y, XINPUT_GAMEPAD_LEFT_SHOULDER, XINPUT_GAMEPAD_RIGHT_SHOULDER,
...
int cGamepadXInput::GetDeviceChange()
{
    ...
    if (((lDeviceUpdateCount++) % (5 * 60)) > 0)
        return 0; // Update once every 5 seconds
