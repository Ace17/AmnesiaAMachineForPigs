...
cWidgetContextMenu::cWidgetContextMenu(cGuiSet* apSet, cGuiSkin* apSkin)
    : iWidgetMenu(eWidgetType_ContextMenu, apSet, apSkin)
{
    mfTimer = 0;
    mfHideTime = 0;
}
...
void cWidgetContextMenu::UpdateMenuWidth(float afItemTextWidth)
{
    ...
    float fNonTextWidth = mfItemHPadding + mfItemCheckIconSize + mfItemTextLeftPadding + mfItemTextRightPadding + mfItemArrowIconSize + mfItemHPadding;
    ...
    SetArrowPos(cVector3f(fItemWidth - (mfItemHPadding + mfItemArrowIconSize), mfItemArrowIconSize * 0.5f, 0.2f));

    // Set text and check icon offsets, these should not change
    SetTextPos(cVector3f(mfItemHPadding + mfItemCheckIconSize + mfItemTextLeftPadding, mfItemVPadding, 0.2f));
    SetCheckPos(cVector3f(mfItemHPadding, mfItemVPadding, 0.2f));
}
