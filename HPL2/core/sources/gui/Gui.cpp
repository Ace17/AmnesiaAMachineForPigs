...
void cGui::Init(cResources* apResources, cGraphics* apGraphics, cSound* apSound, cScene* apScene, cInput* apInput)
{
...
cGuiGfxElement* cGui::CreateGfxImage(const tString& asFile, eGuiMaterial aMaterial, const cColor& aColor, bool abAddToList)
{
    ////////////////////////////
    // Load image
...
cGuiGfxElement* cGui::CreateGfxTexture(const tString& asFile, eGuiMaterial aMaterial, eTextureType aTextureType, const cColor& aColor, bool abMipMaps, bool abAddToList)
{
    ///////////////////
    // Error check
...
cGuiGfxElement* cGui::CreateGfxTexture(iTexture* apTexture,
...
cGuiGfxElement* cGui::CreateGfxImageBuffer(const tString& asFile, eGuiMaterial aMaterial, bool abCreateAnimation, const cColor& aColor, bool abAddToList)
{
    ////////////////////////////
    // Load images
