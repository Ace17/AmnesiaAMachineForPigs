...
iGuiPopUp::iGuiPopUp(cGuiSet* apSet, bool abAddCloseButton, const cVector2f& avPopUpSize)
{
    ...
    mpWindow = mpSet->CreateWidgetWindow(abAddCloseButton ? eWidgetWindowButtonFlag_ButtonClose : eWidgetWindowButtonFlag_None, vPos, avPopUpSize, _W(""), NULL);
...
bool iGuiPopUp::RunCallback(void* apObj, tGuiCallbackFunc apCallback, iWidget* apWidget, const cGuiMessageData& aData, bool abRunFocusChangeChecks)
{
