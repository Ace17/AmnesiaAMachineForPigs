...
cParticleSystemData::cParticleSystemData(const tString& asName, cResources* apResources, cGraphics* apGraphics)
...
cParticleSystem::cParticleSystem(const tString asName, cParticleSystemData* apData, cResources* apResources, cGraphics* apGraphics)
    : iEntity3D(asName)
{
    mpResources = apResources;
    mpGraphics = apGraphics;
