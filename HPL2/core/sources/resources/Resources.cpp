...
void cResources::Init(cGraphics* apGraphics, cSystem* apSystem, cSound* apSound, cScene* apScene, cGui* apGui, cPhysics* apPhysics)
{
...
bool cResources::AddLanguageFile(const tString& asFilePath, bool abAddResourceDirs, const tWString& asAltPath)
{
    ...
    return mpLanguageFile->AddFromFile(asFilePath, abAddResourceDirs, asAltPath);
}
