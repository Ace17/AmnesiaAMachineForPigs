...
#define kBeginWorldEntityLoad() tString sName = apElement->GetAttributeString("Name");
...
cBillboard* cEngineFileLoading::LoadBillboard(cXmlElement* apElement,
...
iLight* cEngineFileLoading::LoadLight(cXmlElement* apElement, const tString& asNamePrefix, cWorld* apWorld, cResources* apResources, bool abStatic)
{
    ...
    pLight->SetFlicker(apElement->GetAttributeColor("FlickerOffColor"), apElement->GetAttributeFloat("FlickerOffRadius"),

          apElement->GetAttributeFloat("FlickerOnMinLength"), apElement->GetAttributeFloat("FlickerOnMaxLength"), apElement->GetAttributeString("FlickerOnSound"),
          apElement->GetAttributeString("FlickerOnPS"),

          apElement->GetAttributeFloat("FlickerOffMaxLength"), apElement->GetAttributeFloat("FlickerOffMinLength"), apElement->GetAttributeString("FlickerOffSound"),
          apElement->GetAttributeString("FlickerOffPS"),

          apElement->GetAttributeBool("FlickerFade"), apElement->GetAttributeFloat("FlickerOnFadeMinLength", fDefaultFadeOn),
          apElement->GetAttributeFloat("FlickerOnFadeMaxLength", fDefaultFadeOn),

          apElement->GetAttributeFloat("FlickerOffFadeMinLength", fDefaultFadeOff), apElement->GetAttributeFloat("FlickerOffFadeMaxLength", fDefaultFadeOff));
...
eVertexBufferElement glDecalElementType[4] = { eVertexBufferElement_Position, eVertexBufferElement_Normal, eVertexBufferElement_Texture0, eVertexBufferElement_Texture1Tangent };
cMesh* cEngineFileLoading::LoadDecalMeshHelper(cXmlElement* apElement,
      ...
      const cColor& aColor)
{
    ...
    iVertexBuffer* pVtxBuffer = apGraphics->GetLowLevel()->CreateVertexBuffer(
          eVertexBufferType_Software, eVertexBufferDrawType_Tri, eVertexBufferUsageType_Static, lNumOfVtx, lNumOfIdx);
