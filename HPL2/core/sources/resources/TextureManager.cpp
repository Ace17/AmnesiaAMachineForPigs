...
iTexture* cTextureManager::Create1D(const tString& asName, bool abUseMipMaps, eTextureUsage aUsage, unsigned int alTextureSizeLevel)
{
...
iTexture* cTextureManager::Create2D(const tString& asName, bool abUseMipMaps, eTextureType aType, eTextureUsage aUsage, unsigned int alTextureSizeLevel)
{
...
iTexture* cTextureManager::Create3D(const tString& asName, bool abUseMipMaps, eTextureUsage aUsage, unsigned int alTextureSizeLevel)
{
...
iTexture* cTextureManager::CreateFlattened3D(const tString& asName, bool abUseMipMaps, eTextureUsage aUsage, unsigned int alTextureSizeLevel)
{
...
iTexture* cTextureManager::CreateAnim(const tString& asFirstFrameName, bool abUseMipMaps, eTextureType aType, eTextureUsage aUsage, unsigned int alTextureSizeLevel)
{
...
iTexture* cTextureManager::CreateCubeMap(const tString& asPathName, bool abUseMipMaps, eTextureUsage aUsage, unsigned int alTextureSizeLevel)
{
...
iTexture*
cTextureManager::CreateSimpleTexture(const tString& asName, bool abUseMipMaps, eTextureUsage aUsage, eTextureType aType, unsigned int alTextureSizeLevel, bool isFlattened3d)
{
    tWString sPath;
    iTexture* pTexture;
