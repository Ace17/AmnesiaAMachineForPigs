...
iGamepad::iGamepad(tString asName, int alIndex)
    : iInputDevice(asName, eInputDeviceType_Gamepad)
{
    mlIndex = alIndex;
}
...
tString iGamepad::ButtonToString(eGamepadButton aButton)
{
    ...
    {
#if USE_SDL2 && !WIN32
    case eGamepadButton_A:
        return "Button A";
    case eGamepadButton_B:
        return "Button B";
    case eGamepadButton_X:
        return "Button X";
    case eGamepadButton_Y:
        return "Button Y";
    case eGamepadButton_Back:
        return "Button Back";
    case eGamepadButton_Guide:
        return "Button Guide";
    case eGamepadButton_Start:
        return "Button Start";
    case eGamepadButton_LeftStick:
        return "Button LeftStick";
    case eGamepadButton_RightStick:
        return "Button RightStick";
    case eGamepadButton_LeftShoulder:
        return "Button LeftShoulder";
    case eGamepadButton_RightShoulder:
        return "Button RightShoulder";
    case eGamepadButton_DpadUp:
        return "Button DpadUp";
    case eGamepadButton_DpadDown:
        return "Button DpadDown";
    case eGamepadButton_DpadLeft:
        return "Button DpadLeft";
    case eGamepadButton_DpadRight:
...
{
#if USE_SDL2 && !WIN32
    if (asButton == "Button A")
        return eGamepadButton_A;
    if (asButton == "Button B")
        return eGamepadButton_B;
    if (asButton == "Button X")
        return eGamepadButton_X;
    if (asButton == "Button Y")
        return eGamepadButton_Y;
    if (asButton == "Button Back")
        return eGamepadButton_Back;
    if (asButton == "Button Guide")
        return eGamepadButton_Guide;
    if (asButton == "Button Start")
        return eGamepadButton_Start;
    if (asButton == "Button LeftStick")
        return eGamepadButton_LeftStick;
    if (asButton == "Button RightStick")
        return eGamepadButton_RightStick;
    if (asButton == "Button LeftShoulder")
        return eGamepadButton_LeftShoulder;
    if (asButton == "Button RightShoulder")
        return eGamepadButton_RightShoulder;
    if (asButton == "Button DpadUp")
        return eGamepadButton_DpadUp;
    if (asButton == "Button DpadDown")
        return eGamepadButton_DpadDown;
    if (asButton == "Button DpadLeft")
        return eGamepadButton_DpadLeft;
    if (asButton == "Button DpadRight")
        return eGamepadButton_DpadRight;
#else
...
tString iGamepad::AxisToString(eGamepadAxis aAxis)
{
    ...
    {
#if USE_SDL2 && !WIN32
    case eGamepadAxis_LeftX:
        return "Axis LeftX";
    case eGamepadAxis_LeftY:
        return "Axis LeftY";
    case eGamepadAxis_RightX:
        return "Axis RightX";
    case eGamepadAxis_RightY:
        return "Axis RightY";
    case eGamepadAxis_LeftTrigger:
        return "Axis LeftTrigger";
    case eGamepadAxis_RightTrigger:
...
{
#if USE_SDL2 && !WIN32
    if (asAxis == "Axis LeftX")
        return eGamepadAxis_LeftX;
    if (asAxis == "Axis LeftY")
        return eGamepadAxis_LeftY;
    if (asAxis == "Axis RightX")
        return eGamepadAxis_RightX;
    if (asAxis == "Axis RightY")
        return eGamepadAxis_RightY;
    if (asAxis == "Axis LeftTrigger")
        return eGamepadAxis_LeftTrigger;
    if (asAxis == "Axis RightTrigger")
        return eGamepadAxis_RightTrigger;
#else
    if (asAxis == "Axis 0")
