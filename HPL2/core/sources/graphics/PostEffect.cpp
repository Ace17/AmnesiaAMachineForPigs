...
void iPostEffect::DrawQuad(const cVector3f& avPos, const cVector2f& avSize, iTexture* apTexture, bool abFlipY)
{
    ...
    mpCurrentComposite->DrawQuad(avPos, avSize, cVector2f(vUvPos.x, (vTexSize.y - vUvSize.y) - vUvPos.y), cVector2f(vUvPos.x + vUvSize.x, vTexSize.y - vUvPos.y), abFlipY);
}

//-----------------------------------------------------------------------

void iPostEffect::DrawQuad(const cVector3f& avPos, const cVector2f& avSize, iTexture* apTexture0, iTexture* apTexture1, bool abFlipY0, bool abFlipY1)
{
