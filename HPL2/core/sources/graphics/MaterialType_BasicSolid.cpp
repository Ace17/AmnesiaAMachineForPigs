...
void cMaterialType_SolidDiffuse::LoadSpecificData()
{
    ...
    mpProgramManager->SetupGenerateProgramData(
          eMaterialRenderMode_Diffuse, "Diffuse", "deferred_base_vtx.glsl", "deferred_gbuffer_solid_frag.glsl", vDiffuseFeatureVec, kDiffuseFeatureNum, defaultVars);
    ...
    defaultVars.Add("UseUv");
    mpProgramManager->SetupGenerateProgramData(
          eMaterialRenderMode_Illumination, "Illum", "deferred_base_vtx.glsl", "deferred_illumination_frag.glsl", vIllumFeatureVec, kIllumFeatureNum, defaultVars);

    mpProgramManager->SetupGenerateProgramData(
          eMaterialRenderMode_IlluminationModulate, "IllumMod", "deferred_base_vtx.glsl", "deferred_illumination_mod_frag.glsl", vIllumFeatureVec, kIllumFeatureNum, defaultVars);
...
void cMaterialType_SolidDiffuse::SetupMaterialSpecificData(eMaterialRenderMode aRenderMode, iGpuProgram* apProgram, cMaterial* apMaterial, iRenderer* apRenderer)
{
    if (aRenderMode == eMaterialRenderMode_Diffuse || aRenderMode == eMaterialRenderMode_Z || aRenderMode == eMaterialRenderMode_Z_Dissolve ||
          aRenderMode == eMaterialRenderMode_Illumination || aRenderMode == eMaterialRenderMode_IlluminationModulate)
    {
        /////////////////////////
        // UV Animation
        if (apMaterial->HasUvAnimation())
...
void cMaterialType_SolidDiffuse::SetupObjectSpecificData(eMaterialRenderMode aRenderMode, iGpuProgram* apProgram, iRenderable* apObject, iRenderer* apRenderer)
{
