...
cAnimationTrack::cAnimationTrack(const tString& asName, tAnimTransformFlag aTransformFlags, cAnimation* apParent)
{
    msName = asName;
...
cKeyFrame cAnimationTrack::GetInterpolatedKeyFrame(float afTime, bool bLoop)
{
    ...
    else
    {
        ...
        ResultKeyFrame.rotation = cMath::QuaternionSlerp(fT, rotA, rotB, true);
