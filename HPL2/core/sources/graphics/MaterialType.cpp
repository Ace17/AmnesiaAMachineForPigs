...
void iMaterialType::AddVar(const tString& asName, eVariableType aType, const tString& asDefaultValue, const tString& asDesc, const tStringVec& avEnumValues)
{
...
{
    tString sValue = cString::ToString(avDefaultValue.x, -1, true) + " " + cString::ToString(avDefaultValue.y, -1, true);
...
{
    tString sValue = cString::ToString(avDefaultValue.x, -1, true) + " " + cString::ToString(avDefaultValue.y, -1, true) + " " + cString::ToString(avDefaultValue.z, -1, true);
...
{
    tString sValue = cString::ToString(aDefaultValue.r, -1, true) + " " + cString::ToString(aDefaultValue.g, -1, true) + " " + cString::ToString(aDefaultValue.b, -1, true) + " " +
