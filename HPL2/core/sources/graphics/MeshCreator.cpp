...
cMesh* cMeshCreator::CreatePlane(const tString& asName,
      ...
      const tString& asMaterial)
{
    ...
    iVertexBuffer* pVtxBuffer = mpLowLevelGraphics->CreateVertexBuffer(eVertexBufferType_Hardware, eVertexBufferDrawType_Tri, eVertexBufferUsageType_Dynamic, 4, 6);
    ...
    cVector3f vTexCoords[4] = {
        cVector3f(avCorner1UV.x, avCorner1UV.y, 0), cVector3f(avCorner2UV.x, avCorner2UV.y, 0), // Start Corner
        cVector3f(avCorner3UV.x, avCorner3UV.y, 0), cVector3f(avCorner4UV.x, avCorner4UV.y, 0) // End Corner
    };
...
cMesh* cMeshCreator::CreateSphere(const tString& asName, float afRadius, int alSections, int alSlices, const tString& asMaterial)
{
    ...
    iVertexBuffer* pVtxBuffer = mpLowLevelGraphics->CreateVertexBuffer(eVertexBufferType_Hardware, eVertexBufferDrawType_Tri, eVertexBufferUsageType_Static);
    pVtxBuffer->CreateElementArray(eVertexBufferElement_Position, eVertexBufferElementFormat_Float, 4);
    pVtxBuffer->CreateElementArray(eVertexBufferElement_Normal, eVertexBufferElementFormat_Float, 3);
    pVtxBuffer->CreateElementArray(eVertexBufferElement_Color0, eVertexBufferElementFormat_Float, 4);
    pVtxBuffer->CreateElementArray(eVertexBufferElement_Texture0, eVertexBufferElementFormat_Float, 3);
...
{
    iVertexBuffer* pSkyBox = mpLowLevelGraphics->CreateVertexBuffer(eVertexBufferType_Hardware, eVertexBufferDrawType_Quad, eVertexBufferUsageType_Static);
...
{
    iVertexBuffer* pBox = mpLowLevelGraphics->CreateVertexBuffer(eVertexBufferType_Hardware, eVertexBufferDrawType_Tri, eVertexBufferUsageType_Static);
...
void cMeshCreator::CreateCircumference(float afRadius, float afAngleStep, float afHeight, tVector3fVec& avVertices)
{
    ...
    {
        cVector3f vPoint = cVector3f(
              cMath::RoundFloatToDecimals(afRadius * cos(fAngle), 6), cMath::RoundFloatToDecimals(afHeight, 6), cMath::RoundFloatToDecimals(afRadius * sin(fAngle), 6));
