...
class cEntityWrapperTypeParticleEmitter : public iEntityWrapperType
{
public:
	cEntityWrapperTypeParticleEmitter();
...
class cEntityWrapperDataParticleEmitter : public iEntityWrapperData
{
public:
...
protected:
	...
	//iEntityWrapper* CreateSpecificEntityWrapper(iEditorWorld* apEditorWorld);
	/*
...
class cEntityWrapperParticleEmitter : public iEntityWrapper
{
public:
	cEntityWrapperParticleEmitter(iEntityWrapperData*);
