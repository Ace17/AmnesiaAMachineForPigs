...
cLuxAnimatedPropLoader::cLuxAnimatedPropLoader(const tString& asName)
...
void cLuxAnimatedPropLoader::BeforeLoad(cXmlElement* apRootElem, const cMatrixf& a_mtxTransform, cWorld* apWorld, cResourceVarsObject* apInstanceVars)
{
}

//-----------------------------------------------------------------------

void cLuxAnimatedPropLoader::AfterLoad(cXmlElement* apRootElem, const cMatrixf& a_mtxTransform, cWorld* apWorld, cResourceVarsObject* apInstanceVars)
{
    ...
    /*cLuxAnimatedProp *pStaticProp = hplNew( cLuxAnimatedProp, (msName, mlID) );
...
cLuxAnimatedProp::cLuxAnimatedProp(const tString& asName, int alID)
{
    msName = asName;
    mlID = alID;
}

cLuxAnimatedProp::~cLuxAnimatedProp()
{
...
kBeginSerializeBase(iLuxAnimatedProp_SaveData)
