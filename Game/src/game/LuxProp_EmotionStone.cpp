...
cLuxPropLoader_EmotionStone::cLuxPropLoader_EmotionStone(const tString& asName)
...
cLuxProp_EmotionStone::cLuxProp_EmotionStone(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxProp(asName, alID, apMap, eLuxPropType_EmotionStone)
{
}
