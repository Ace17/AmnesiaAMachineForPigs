...
cLuxPropLoader_Chest::cLuxPropLoader_Chest(const tString& asName)
...
cLuxProp_Chest::cLuxProp_Chest(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxProp(asName, alID, apMap, eLuxPropType_Chest)
{
    mbLocked = false;
