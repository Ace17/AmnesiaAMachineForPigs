...
static cLuxAction gvLuxActions[] = { cLuxAction("Exit", eLuxAction_Exit, false, eLuxActionCategory_System),
    cLuxAction("ExitDirect", eLuxAction_ExitDirect, false, eLuxActionCategory_System), cLuxAction("ScreenShot", eLuxAction_ScreenShot, false, eLuxActionCategory_System),
    cLuxAction("PrintInfo", eLuxAction_PrintInfo, false, eLuxActionCategory_System),

    cLuxAction("LeftClick", eLuxAction_LeftClick, false, eLuxActionCategory_System), cLuxAction("MiddleClick", eLuxAction_MiddleClick, false, eLuxActionCategory_System),
    cLuxAction("RightClick", eLuxAction_RightClick, false, eLuxActionCategory_System), cLuxAction("ScrollUp", eLuxAction_ScrollUp, false, eLuxActionCategory_System),
    cLuxAction("ScrollDown", eLuxAction_ScrollDown, false, eLuxActionCategory_System), cLuxAction("MouseButton6", eLuxAction_MouseButton6Click, false, eLuxActionCategory_System),
    ...
    cLuxAction("UIArrowUp", eLuxAction_UIArrowUp, false, eLuxActionCategory_System), cLuxAction("UIArrowLeft", eLuxAction_UIArrowLeft, false, eLuxActionCategory_System),
    cLuxAction("UIArrowDown", eLuxAction_UIArrowDown, false, eLuxActionCategory_System), cLuxAction("UIArrowRight", eLuxAction_UIArrowRight, false, eLuxActionCategory_System),

    cLuxAction("UIPrimary", eLuxAction_UIPrimary, false, eLuxActionCategory_System), cLuxAction("UISecondary", eLuxAction_UISecondary, false, eLuxActionCategory_System),
    cLuxAction("UIPrevPage", eLuxAction_UIPrevPage, false, eLuxActionCategory_System), cLuxAction("UINextPage", eLuxAction_UINextPage, false, eLuxActionCategory_System),
    cLuxAction("UIDelete", eLuxAction_UIDelete, false, eLuxActionCategory_System), cLuxAction("UIClear", eLuxAction_UIClear, false, eLuxActionCategory_System),

    cLuxAction("OpenDebug", eLuxAction_OpenDebug, false, eLuxActionCategory_System), cLuxAction("QuickSave", eLuxAction_QuickSave, false, eLuxActionCategory_System),
    ...
    cLuxAction("Journal", eLuxAction_Journal, true, eLuxActionCategory_Misc), cLuxAction("QuestLog", eLuxAction_QuestLog, true, eLuxActionCategory_Misc),
    ...
    cLuxAction("Forward", eLuxAction_Forward, true, eLuxActionCategory_Movement), cLuxAction("Backward", eLuxAction_Backward, true, eLuxActionCategory_Movement),
    cLuxAction("Right", eLuxAction_Right, true, eLuxActionCategory_Movement), cLuxAction("Left", eLuxAction_Left, true, eLuxActionCategory_Movement),

    cLuxAction("LeanRight", eLuxAction_LeanRight, true, eLuxActionCategory_Movement), cLuxAction("LeanLeft", eLuxAction_LeanLeft, true, eLuxActionCategory_Movement),

#ifdef USE_GAMEPAD
    cLuxAction("Lean", eLuxAction_Lean, true, eLuxActionCategory_Movement), cLuxAction("ZoomOut", eLuxAction_ZoomOut, false, eLuxActionCategory_Action),
    cLuxAction("ZoomIn", eLuxAction_ZoomIn, false, eLuxActionCategory_Action),
#endif

    cLuxAction("Attack", eLuxAction_Attack, true, eLuxActionCategory_Action), cLuxAction("Interact", eLuxAction_Interact, true, eLuxActionCategory_Action),
    cLuxAction("Ignite", eLuxAction_Ignite, false, eLuxActionCategory_Action), cLuxAction("Rotate", eLuxAction_Rotate, true, eLuxActionCategory_Action),
    cLuxAction("Holster", eLuxAction_Holster, false, eLuxActionCategory_Action), cLuxAction("Lantern", eLuxAction_Lantern, true, eLuxActionCategory_Action),

    cLuxAction("Run", eLuxAction_Run, true, eLuxActionCategory_Movement), cLuxAction("Crouch", eLuxAction_Crouch, true, eLuxActionCategory_Movement),
...
static cLuxInput gvLuxInputs[] = { cLuxInput("Keyboard", eKey_Escape, eLuxAction_Exit), cLuxInput("Keyboard", eKey_F12, eLuxAction_ExitDirect),
    cLuxInput("Keyboard", eKey_F8, eLuxAction_ScreenShot), cLuxInput("Keyboard", eKey_P, eLuxAction_PrintInfo),

    cLuxInput("MouseButton", eMouseButton_Left, eLuxAction_LeftClick), cLuxInput("MouseButton", eMouseButton_Middle, eLuxAction_MiddleClick),
    cLuxInput("MouseButton", eMouseButton_Right, eLuxAction_RightClick), cLuxInput("MouseButton", eMouseButton_WheelUp, eLuxAction_ScrollUp),
    cLuxInput("MouseButton", eMouseButton_WheelDown, eLuxAction_ScrollDown), cLuxInput("MouseButton", eMouseButton_Button6, eLuxAction_MouseButton6Click),
    cLuxInput("MouseButton", eMouseButton_Button7, eLuxAction_MouseButton7Click), cLuxInput("MouseButton", eMouseButton_Button8, eLuxAction_MouseButton8Click),
    cLuxInput("MouseButton", eMouseButton_Button9, eLuxAction_MouseButton9Click),

#ifdef USE_GAMEPAD
#if USE_SDL2
    cLuxInput("GamepadButton", eGamepadButton_DpadUp, eLuxAction_UIArrowUp), cLuxInput("GamepadButton", eGamepadButton_DpadDown, eLuxAction_UIArrowDown),
    cLuxInput("GamepadButton", eGamepadButton_DpadLeft, eLuxAction_UIArrowLeft), cLuxInput("GamepadButton", eGamepadButton_DpadRight, eLuxAction_UIArrowRight),

    cLuxInput("GamepadAxis.Axis LeftY", eGamepadAxisRange_Negative, eLuxAction_UIArrowUp), cLuxInput("GamepadAxis.Axis LeftX", eGamepadAxisRange_Positive, eLuxAction_UIArrowRight),
    ...
    cLuxInput("GamepadButton", eGamepadButton_A, eLuxAction_UIPrimary), cLuxInput("GamepadButton", eGamepadButton_B, eLuxAction_UISecondary),
    cLuxInput("GamepadButton", eGamepadButton_LeftShoulder, eLuxAction_UIPrevPage), cLuxInput("GamepadButton", eGamepadButton_RightShoulder, eLuxAction_UINextPage),
    ...
    cLuxInput("GamepadButton", eGamepadButton_X, eLuxAction_UIDelete), cLuxInput("GamepadButton", eGamepadButton_Y, eLuxAction_UIClear),
#else
    cLuxInput("GamepadHat.Hat 0", eGamepadHatState_Up, eLuxAction_UIArrowUp), cLuxInput("GamepadHat.Hat 0", eGamepadHatState_Down, eLuxAction_UIArrowDown),
    cLuxInput("GamepadHat.Hat 0", eGamepadHatState_Left, eLuxAction_UIArrowLeft), cLuxInput("GamepadHat.Hat 0", eGamepadHatState_Right, eLuxAction_UIArrowRight),

    cLuxInput("GamepadAxis.Axis 1", eGamepadAxisRange_Negative, eLuxAction_UIArrowUp), cLuxInput("GamepadAxis.Axis 0", eGamepadAxisRange_Positive, eLuxAction_UIArrowRight),
    cLuxInput("GamepadAxis.Axis 1", eGamepadAxisRange_Positive, eLuxAction_UIArrowDown), cLuxInput("GamepadAxis.Axis 0", eGamepadAxisRange_Negative, eLuxAction_UIArrowLeft),

    cLuxInput("GamepadButton", eGamepadButton_0, eLuxAction_UIPrimary), cLuxInput("GamepadButton", eGamepadButton_1, eLuxAction_UISecondary),
    cLuxInput("GamepadButton", eGamepadButton_4, eLuxAction_UIPrevPage), cLuxInput("GamepadButton", eGamepadButton_5, eLuxAction_UINextPage),
    cLuxInput("GamepadAxis.Axis 2", eGamepadAxisRange_Positive, eLuxAction_UIPrevPage), cLuxInput("GamepadAxis.Axis 2", eGamepadAxisRange_Negative, eLuxAction_UINextPage),

    cLuxInput("GamepadButton", eGamepadButton_2, eLuxAction_UIDelete), cLuxInput("GamepadButton", eGamepadButton_3, eLuxAction_UIClear),
#endif
#endif

    cLuxInput("Keyboard", eKey_Return, eLuxAction_UIPrimary),

    cLuxInput("Keyboard", eKey_F1, eLuxAction_OpenDebug), cLuxInput("Keyboard", eKey_F4, eLuxAction_QuickSave), cLuxInput("Keyboard", eKey_F5, eLuxAction_QuickLoad),

    //	cLuxInput("Keyboard", eKey_Tab, eLuxAction_Inventory),
    cLuxInput("Keyboard", eKey_J, eLuxAction_Journal), cLuxInput("Keyboard", eKey_M, eLuxAction_QuestLog),
    //	cLuxInput("Keyboard", eKey_N, eLuxAction_RecentText),
    cLuxInput("Keyboard", eKey_X, eLuxAction_CrosshairToggle),

    cLuxInput("Keyboard", eKey_W, eLuxAction_Forward), cLuxInput("Keyboard", eKey_S, eLuxAction_Backward), cLuxInput("Keyboard", eKey_D, eLuxAction_Right),
    cLuxInput("Keyboard", eKey_A, eLuxAction_Left),

    cLuxInput("Keyboard", eKey_E, eLuxAction_LeanRight), cLuxInput("Keyboard", eKey_Q, eLuxAction_LeanLeft),

    cLuxInput("MouseButton", eMouseButton_Right, eLuxAction_Attack), cLuxInput("MouseButton", eMouseButton_Left, eLuxAction_Interact),
    cLuxInput("Keyboard", eKey_C, eLuxAction_Ignite), cLuxInput("Keyboard", eKey_R, eLuxAction_Rotate), cLuxInput("Keyboard", eKey_H, eLuxAction_Holster),
    cLuxInput("Keyboard", eKey_F, eLuxAction_Lantern),

    cLuxInput("Keyboard", eKey_LeftShift, eLuxAction_Run), cLuxInput("Keyboard", eKey_LeftCtrl, eLuxAction_Crouch), cLuxInput("Keyboard", eKey_Space, eLuxAction_Jump),

#ifdef _DEBUG

    cLuxInput("Keyboard", eKey_0, eLuxAction_InfectionLevelZero), cLuxInput("Keyboard", eKey_1, eLuxAction_InfectionLevelOne),
    cLuxInput("Keyboard", eKey_2, eLuxAction_InfectionLevelTwo), cLuxInput("Keyboard", eKey_3, eLuxAction_InfectionLevelThree),
    cLuxInput("Keyboard", eKey_4, eLuxAction_InfectionLevelFour), cLuxInput("Keyboard", eKey_N, eLuxAction_DumpPigInfo),
...
#ifdef USE_GAMEPAD
#if USE_SDL2
    cLuxInput("GamepadAxis.Axis LeftY", eGamepadAxisRange_Negative, eLuxAction_Forward), cLuxInput("GamepadAxis.Axis LeftX", eGamepadAxisRange_Positive, eLuxAction_Right),
    cLuxInput("GamepadAxis.Axis LeftY", eGamepadAxisRange_Positive, eLuxAction_Backward), cLuxInput("GamepadAxis.Axis LeftX", eGamepadAxisRange_Negative, eLuxAction_Left),

    cLuxInput("GamepadButton", eGamepadButton_A, eLuxAction_Jump), cLuxInput("GamepadButton", eGamepadButton_B, eLuxAction_Crouch),
    cLuxInput("GamepadButton", eGamepadButton_X, eLuxAction_Lantern), cLuxInput("GamepadButton", eGamepadButton_Y, eLuxAction_Journal),
    cLuxInput("GamepadButton", eGamepadButton_LeftShoulder, eLuxAction_Attack), cLuxInput("GamepadButton", eGamepadButton_RightShoulder, eLuxAction_Interact),
    cLuxInput("GamepadButton", eGamepadButton_Start, eLuxAction_Exit), cLuxInput("GamepadButton", eGamepadButton_LeftStick, eLuxAction_QuestLog),
    cLuxInput("GamepadButton", eGamepadButton_RightStick, eLuxAction_Rotate), cLuxInput("GamepadAxis.Axis LeftTrigger", eGamepadAxisRange_Positive, eLuxAction_Run),
    cLuxInput("GamepadAxis.Axis RightTrigger", eGamepadAxisRange_Positive, eLuxAction_Lean),

    cLuxInput("GamepadButton", eGamepadButton_DpadUp, eLuxAction_ZoomOut), cLuxInput("GamepadButton", eGamepadButton_DpadDown, eLuxAction_ZoomIn),
#else
    cLuxInput("GamepadAxis.Axis 1", eGamepadAxisRange_Negative, eLuxAction_Forward), cLuxInput("GamepadAxis.Axis 0", eGamepadAxisRange_Positive, eLuxAction_Right),
    cLuxInput("GamepadAxis.Axis 1", eGamepadAxisRange_Positive, eLuxAction_Backward), cLuxInput("GamepadAxis.Axis 0", eGamepadAxisRange_Negative, eLuxAction_Left),

    cLuxInput("GamepadButton", eGamepadButton_0, eLuxAction_Jump), cLuxInput("GamepadButton", eGamepadButton_1, eLuxAction_Crouch),
    cLuxInput("GamepadButton", eGamepadButton_2, eLuxAction_Lantern), cLuxInput("GamepadButton", eGamepadButton_3, eLuxAction_Journal),
    cLuxInput("GamepadButton", eGamepadButton_4, eLuxAction_Attack), cLuxInput("GamepadButton", eGamepadButton_5, eLuxAction_Interact),
    cLuxInput("GamepadButton", eGamepadButton_7, eLuxAction_Exit), cLuxInput("GamepadButton", eGamepadButton_8, eLuxAction_QuestLog),
    cLuxInput("GamepadButton", eGamepadButton_9, eLuxAction_Rotate), cLuxInput("GamepadAxis.Axis 2", eGamepadAxisRange_Positive, eLuxAction_Run),
    cLuxInput("GamepadAxis.Axis 2", eGamepadAxisRange_Negative, eLuxAction_Lean),

    cLuxInput("GamepadHat.Hat 0", eGamepadHatState_Up, eLuxAction_ZoomOut), cLuxInput("GamepadHat.Hat 0", eGamepadHatState_Down, eLuxAction_ZoomIn),
#endif
#endif
...
static tString gvLuxInputPos[] = { "Primary", "Secondary",
...
cLuxInputHandler::cLuxInputHandler()
    : iLuxUpdateable("LuxInputHandler")
{
    ////////////////////////////////////
...
void cLuxInputHandler::LoadUserConfig()
{
    ...
    for (int i = 0; gvLuxActions[i].msName != ""; ++i)
    {
        ...
        for (size_t j = 0; gvLuxInputPos[j] != ""; ++j)
        {
            ...
            bHasUserDefinedInputs = CreateSubActionFromInputString(pAction, sInput) || bHasUserDefinedInputs;
        }
...
cVector2f cLuxInputHandler::GetSluggishMousePos(const cVector2f& avRelPosMouse)
{
    ...
    if ((int)mlstSluggishMousePos.size() > mlMaxSluggishMousePos)
        mlstSluggishMousePos.pop_back();
...
bool cLuxInputHandler::UpdateGamepadUIInput()
{
    ...
    int vActionIDs[] = { eLuxAction_UIArrowUp, eLuxAction_UIArrowRight, eLuxAction_UIArrowDown, eLuxAction_UIArrowLeft,

        -1,

        eLuxAction_UIPrimary, eLuxAction_UISecondary, eLuxAction_UIPrevPage, eLuxAction_UINextPage, eLuxAction_Interact, eLuxAction_UIDelete, eLuxAction_UIClear,

        -1 };

    int vInputIDs[] = { eUIArrow_Up, eUIArrow_Right, eUIArrow_Down, eUIArrow_Left,

        -1,

        eUIButton_Primary, eUIButton_Secondary, eUIButton_PrevPage, eUIButton_NextPage, eUIButton_Interact, eUIButton_Delete, eUIButton_Clear,
...
void cLuxInputHandler::FadeEventSensitityModifierTo(float afTime, float afGoalSensitivity)
{
    ...
    if (afTime <= 0)
        ...
        mfEventSensitivityModifierSpeed = 1 / afTime;
}
...
void cLuxInputHandler::UpdateGamePlayerInput()
{
    ...
    if (mpPlayer->IsDead())
    {
        if (mpInput->BecameTriggerd(eLuxAction_Attack) || mpInput->BecameTriggerd(eLuxAction_Interact) || mpInput->BecameTriggerd(eLuxAction_Ignite) ||
              mpInput->BecameTriggerd(eLuxAction_Jump) || mpInput->BecameTriggerd(eLuxAction_Crouch))
        {
    ...
    cVector2f vMouseRelPosFloat = cVector2f(vMouseRelPos.x, vMouseRelPos.y) * mfMouseSensitivity * mfPointerSpeed *
          (mpPlayer->IsAtMaxInfectionLevel() ? mfSensitivityDropAtMaxLevel : 1.0f) * mfEventSensitivityModifier;
...
void cLuxInputHandler::UpdateInventoryInput()
{
    ...
    ////////////////////
    // Exit
    if (mpInput->BecameTriggerd(eLuxAction_Exit) || mpInput->BecameTriggerd(eLuxAction_Inventory))
    {
    ...
    if (gpBase->mpInventory->GetMessageActive())
    {
        ...
        if (mpInput->BecameTriggerd(eLuxAction_LeftClick) || mpInput->BecameTriggerd(eLuxAction_MiddleClick) || mpInput->BecameTriggerd(eLuxAction_RightClick) ||
              mpInput->BecameTriggerd(eLuxAction_UIPrimary) || mpInput->BecameTriggerd(eLuxAction_UISecondary))
        {
...
void cLuxInputHandler::UpdateJournalInput()
{
    ...
    else if (mpInput->BecameTriggerd(eLuxAction_Journal) || mpInput->BecameTriggerd(eLuxAction_QuestLog) || mpInput->BecameTriggerd(eLuxAction_Inventory) ||
