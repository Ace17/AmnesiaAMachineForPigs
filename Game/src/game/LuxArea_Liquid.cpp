...
cLuxAreaLoader_Liquid::cLuxAreaLoader_Liquid(const tString& asName)
...
cLuxArea_Liquid::cLuxArea_Liquid(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxArea(asName, alID, apMap, eLuxAreaType_Liquid)
{
