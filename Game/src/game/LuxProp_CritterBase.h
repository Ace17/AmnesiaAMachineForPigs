...
{
public:
    cLuxCritterRayCallback(iLuxProp_CritterBase* apCritterBase)
        : mpCritterBase(apCritterBase)
    {
    }
...
{
    kSerializableClassInit(iLuxProp_CritterBase_SaveData) public : virtual ~iLuxProp_CritterBase_SaveData() {}
