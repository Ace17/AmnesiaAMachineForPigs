...
{
    kSerializableClassInit(cLuxProp_PhoneBox_SaveData) public :

        tString msVoiceFile;
    tString msTextEntry1, msTextEntry2, msTextEntry3, msTextEntry4, msTextEntry5, msTextEntry6, msTextEntry7;
    float mfDelay1, mfDelay2, mfDelay3, mfDelay4, mfDelay5, mfDelay6, mfDelay7;
    bool mbPlayerHasInteracted, mbIsRinging, mbIsPlayingVoice;
};
...
private:
    ...
    float mfMoveSpeedMultiplier, mfMouseSensitivityModifier;

    bool mbPlayerHasInteracted, mbIsRinging;
    bool mbIsPlayingVoice;

    cSoundEntity* mpRingingSound;
};
