...
cLuxAreaNodeLoader_PlayerStart::cLuxAreaNodeLoader_PlayerStart(const tString& asName)
    : iAreaLoader(asName)
{
...
cLuxAreaNodeLoader_PathNode::cLuxAreaNodeLoader_PathNode(const tString& asName)
    : iAreaLoader(asName)
{
...
cLuxAreaNodeLoader_PosNode::cLuxAreaNodeLoader_PosNode(const tString& asName)
    : iAreaLoader(asName)
{
    mbCreatesStaticArea = true;
}
