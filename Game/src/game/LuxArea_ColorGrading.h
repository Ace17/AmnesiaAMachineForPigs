...
{
    kSerializableClassInit(cLuxArea_ColorGrading_SaveData) public : iLuxArea* CreateArea(cLuxMap* apMap);

    tString msLookupTable;
    float mfFadeTime;
};
...
private:
    /////////////////////////
    // Variables
    float mfCollisionCheckTimer, mfCollisionCheckInterval;
    bool mbCollidesWithPlayer;
    tString msLookupTable;
    float mfFadeTime;
};
