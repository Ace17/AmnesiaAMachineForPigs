...
public:
    ...
    bool ShapeDamage(iCollideShape* apShape,
    ...
    bool GetClosestEntity(const cVector3f& avStart, const cVector3f& avDir, float afRayLength, float* afDistance, iPhysicsBody** apBody, iLuxEntity** apEntity);

    bool
    GetClosestCharCollider(const cVector3f& avStart, const cVector3f& avDir, float afRayLength, bool abCheckDynamic, float* afDistance, cVector3f* avNormal, iPhysicsBody** apBody);
    ...
    void
    GetLightsAtNode(iRenderableContainerNode* apNode, tLightList& alstLights, const cVector3f& avPos, float afRadius, bool includeInvisible = false, bool includeBoxLights = true);
