...
void cLuxPlayerState_Ladder::Update(float afTimeStep)
{
    ...
    else if (mlState == 1)
    {
        ...
        cVector3f vGroundRayStart1 = pCharBody->GetFeetPosition() + cVector3f(0, 0.05f, 0) + mpLadder->GetForward() * pCharBody->GetSize().x * 0.7f;
        ...
        // Check if at bottom
              ...
              ((mvCharPosition.y - pCharBody->GetSize().y / 2) < mpLadder->GetMinY() || pCharBody->CheckRayIntersection(vGroundRayStart1, vGroundRayEnd1, NULL, NULL) ||
