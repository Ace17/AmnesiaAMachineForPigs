...
cLuxLoadScreenHandler::cLuxLoadScreenHandler()
    : iLuxUpdateable("LuxLoadScreenHandler")
{
    ///////////////////////////////
    // Get Engine
...
void cLuxLoadScreenHandler::DrawGameScreen(cGuiSet* apSet)
{
    ...
    if (msCurrentGameScreenTextEntry != "")
    {
        ...
        apSet->DrawFont(sLoading, mpFontDefault, vPos, mvLoadingFontSize, cColor(mLoadingFontColor.r, mLoadingFontColor.g, mLoadingFontColor.b, mLoadingFontColor.a * fLoadAlpha),
              eFontAlign_Center);
        // apSet->DrawFont(sContinue, mpFontDefault, vPos, mvLoadingFontSize, cColor(mLoadingFontColor.r,mLoadingFontColor.g,mLoadingFontColor.b,mLoadingFontColor.a *
        // fContinueAlpha), eFontAlign_Center);
    }
    //////////////////////
    // Draw loading only
    else
