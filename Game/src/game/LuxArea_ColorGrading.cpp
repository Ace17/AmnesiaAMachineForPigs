...
cLuxAreaLoader_ColorGrading::cLuxAreaLoader_ColorGrading(const tString& asName)
...
cLuxArea_ColorGrading::cLuxArea_ColorGrading(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxArea(asName, alID, apMap, eLuxAreaType_ColorGrading)
{
