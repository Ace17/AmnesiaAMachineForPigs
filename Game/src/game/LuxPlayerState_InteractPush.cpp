...
cLuxPlayerState_InteractPush::cLuxPlayerState_InteractPush(cLuxPlayer* apPlayer)
    : iLuxPlayerState_Interact(apPlayer, eLuxPlayerState_InteractPush)
{
...
void cLuxPlayerState_InteractPush::Update(float afTimeStep)
{
    ...
    bool bWillCollideWithPlayer = pPhysicsWorld->CheckShapeCollision(
          pCharBody->GetCurrentShape(), cMath::MatrixTranslate(pCharBody->GetPosition()), mpCurrentBody->GetShape(), mtxNextTransform, collideData, 1, false);
