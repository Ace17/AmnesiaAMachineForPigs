...
kBeginSerializeBase(cEngineCharacterBody_SaveData) kSerializeVar(mbActive, eSerializeType_Bool)
...
kBeginSerializeBase(cEngineVerletParticle_SaveData) kSerializeVar(mvPosition, eSerializeType_Vector3f)
...
kBeginSerializeBase(cEngineRope_SaveData) kSerializeVar(msName, eSerializeType_String)
...
kBeginSerializeBase(cEngineBillboard_SaveData) kSerializeVar(mColor, eSerializeType_Color)
kEndSerialize()
...
kBeginSerializeBase(cEngineAnimationState_SaveData) kSerializeVar(mbActive, eSerializeType_Bool)
...
kBeginSerializeBase(cEngineSubMeshEntity_SaveData) kSerializeVar(mbActive, eSerializeType_Bool)
...
kBeginSerializeBase(cEngineMeshEntity_SaveData) kSerializeVar(mbActive, eSerializeType_Bool)
kSerializeVar(mbVisible, eSerializeType_Bool)
...
kSerializeClassContainer(mvAnimations, cEngineAnimationState_SaveData, eSerializeType_Class)
      kSerializeClassContainer(mvSubMeshEntities, cEngineSubMeshEntity_SaveData, eSerializeType_Class) kEndSerialize()
...
kBeginSerializeBase(cEngineBody_SaveData) kSerializeVar(mfMass, eSerializeType_Float32)
...
kBeginSerializeBase(cEngineJointController_SaveData) kSerializeVar(msName, eSerializeType_String)
kSerializeVar(mfDestValue, eSerializeType_Float32)
kSerializeVar(mbActive, eSerializeType_Bool)
kEndSerialize()

kBeginSerializeBase(cEngineJoint_SaveData) kSerializeVar(msName, eSerializeType_String)
...
kSerializeClassContainer(mvControllers, cEngineJointController_SaveData, eSerializeType_Class) kEndSerialize()
//------------------------------------------------------------------------
...
kBeginSerializeBase(cEnginePSEmitter_SaveData) kSerializeVar(mbActive, eSerializeType_Bool)
kEndSerialize()

kBeginSerializeBase(cEnginePS_SaveData) kSerializeVar(msName, eSerializeType_String)
kSerializeVar(mlID, eSerializeType_Int32)
...
kSerializeClassContainer(mvEmitterActive, cEnginePSEmitter_SaveData, eSerializeType_Class) kEndSerialize()
...
kBeginSerializeBase(cEngineBeam_SaveData) kSerializeVar(msName, eSerializeType_String)
kSerializeVar(mlID, eSerializeType_Int32)
...
kBeginSerializeBase(cEngineSound_SaveData) kSerializeVar(msName, eSerializeType_String)
kSerializeVar(mlID, eSerializeType_Int32)
kSerializeVar(mbActive, eSerializeType_Bool)
...
void cEngineLight_SaveData::ToLight(iLight* apLight)
{
    ...
    if (bHasParent == false)
    {
        ...
        if (mbFlickering)
        {
            apLight->SetFlicker(mFlickerOffColor, mfFlickerOffRadius, mfFlickerOnMinLength, mfFlickerOnMaxLength, msFlickerOnSound, msFlickerOnPS, mfFlickerOffMinLength,
                  mfFlickerOffMaxLength, msFlickerOffSound, msFlickerOffPS, mbFlickerFade, mfFlickerOnFadeMinLength, mfFlickerOnFadeMaxLength, mfFlickerOffFadeMinLength,
                  mfFlickerOffFadeMaxLength);
        }
    }
}
...
kBeginSerializeBase(cEngineLight_SaveData) kSerializeVar(msName, eSerializeType_String)
kSerializeVar(mlID, eSerializeType_Int32)
kSerializeVar(mbActive, eSerializeType_Bool)
kSerializeVar(mbVisible, eSerializeType_Bool)
