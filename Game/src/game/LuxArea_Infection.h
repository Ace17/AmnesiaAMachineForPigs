...
{
    kSerializableClassInit(cLuxArea_Infection_SaveData) public : iLuxArea* CreateArea(cLuxMap* apMap);

    float mfIncrementSpeed, mfTotalIncrementApplied, mfTotalIncrementBound, mfInfectionLevelLowerBound, mfInfectionLevelUpperBound;
    bool mbDisableOnLevelBoundHit;
};
...
private:
    ...
    /////////////////////////
    // Variables
    float mfCollisionCheckTimer, mfCheckTimeMin, mfCheckTimeMax, mfIncrementSpeed, mfTotalIncrementApplied, mfTotalIncrementBound, mfInfectionLevelLowerBound,
          mfInfectionLevelUpperBound;
    bool mbDisableOnLevelBoundHit, mbCollidesWithPlayer;
};
