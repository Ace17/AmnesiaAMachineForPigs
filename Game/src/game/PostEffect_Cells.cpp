...
namespace hpl
{
cPostEffectType_Cells::cPostEffectType_Cells(cGraphics* apGraphics, cResources* apResources)
    : iPostEffectType("Cells", apGraphics, apResources)
{
}
...
cPostEffect_Cells::cPostEffect_Cells(cGraphics* apGraphics, cResources* apResources, iPostEffectType* apType)
