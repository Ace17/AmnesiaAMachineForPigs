...
cLuxEnemyLoader_Child::cLuxEnemyLoader_Child(const tString& asName)
...
cLuxEnemy_Child::cLuxEnemy_Child(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxEnemy(asName, alID, apMap, eLuxEnemyType_Child)
{
...
bool cLuxEnemy_Child::StateEventImplement(int alState, eLuxEnemyStateEvent aEvent, cLuxStateMessage* apMessage)
{
    kLuxBeginStateMachine
          ...
          kLuxOnMessage(eLuxEnemyMessage_Reset) ChangeState(eLuxEnemyState_Wait);
    ...
    kLuxOnMessage(eLuxEnemyMessage_PlayerDetected)
          ...
          kLuxState(eLuxEnemyState_Idle) kLuxOnEnter SetMoveSpeed(eLuxEnemyMoveSpeed_Walk);
    ...
    kLuxState(eLuxEnemyState_Wait) kLuxOnEnter SendMessage(eLuxEnemyMessage_TimeOut, mfWaitTime, true);
    mfWaitTime = 0;
    ...
    else { SendMessage(eLuxEnemyMessage_TimeOut, cMath::RandRectf(0.1f, 0.3f), true); }
