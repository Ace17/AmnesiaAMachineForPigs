...
cLuxPropLoader_NPC::cLuxPropLoader_NPC(const tString& asName)
...
cLuxProp_NPC::cLuxProp_NPC(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxProp(asName, alID, apMap, eLuxPropType_NPC)
{
    mfHeadAngle = 0;
    mfInAreaCount = 0;
