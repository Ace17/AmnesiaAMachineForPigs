...
cLuxPropLoader_PhoneBox::cLuxPropLoader_PhoneBox(const tString& asName)
...
cLuxProp_PhoneBox::cLuxProp_PhoneBox(const tString& asName, int alID, cLuxMap* apMap)
...
bool cLuxProp_PhoneBox::OnInteract(iPhysicsBody* apBody, const cVector3f& avPos)
{
    ...
    pVoiceFlashback->Start(msVoiceFile, msTextEntry1, mfDelay1, msTextEntry2, mfDelay2, msTextEntry3, mfDelay3, msTextEntry4, mfDelay4, msTextEntry5, mfDelay5, msTextEntry6,
          mfDelay6, msTextEntry7, mfDelay7, false, true);
