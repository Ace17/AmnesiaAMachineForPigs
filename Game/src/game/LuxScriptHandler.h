...
private:
    ...
    static void __stdcall ShowScreenImage(string& asImageName,
          float afX,
          float afY,
          float afScale,
    ...
    // This adds a voice + effect to be played. It is okay to call this many times in order to play many voices in a row. The EffectVoiceOverCallback is not called until ALL voices
    // have finished.
    static void __stdcall AddEffectVoice(string& asVoiceFile,
          string& asEffectFile,
          string& asTextCat,
          string& asTextEntry,
          bool abUsePostion,
    ...
    static void __stdcall AddEffectVoice2(string& asVoiceFile,
          string& asEffectFile,
          string& asTextCat,
          string& asTextEntry,
          float afTextDelay,
    ...
    static void __stdcall AddEffectVoice3(string& asVoiceFile,
          string& asEffectFile,
          string& asTextCat,
          string& asTextEntry,
          float afTextDelay,
    ...
    static void __stdcall AddEffectVoice4(string& asVoiceFile,
          string& asEffectFile,
          string& asTextCat,
          string& asTextEntry,
          float afTextDelay,
    ...
    static void __stdcall AddEffectVoice5(string& asVoiceFile,
          string& asEffectFile,
          string& asTextCat,
          string& asTextEntry,
          float afTextDelay,
    ...
    static void __stdcall AddEffectVoice6(string& asVoiceFile,
          string& asEffectFile,
          string& asTextCat,
          string& asTextEntry,
          float afTextDelay,
    ...
    static void __stdcall AddEffectVoice7(string& asVoiceFile,
          string& asEffectFile,
          string& asTextCat,
          string& asTextEntry,
          float afTextDelay,
    ...
    static void __stdcall AddEffectVoiceExt(string& asVoiceFile,
          string& asEffectFile,
          string& asTextCat,
          string& asTextEntry,
          bool abUsePostion,
    ...
    static void __stdcall CreateParticleSystemAtEntityExt(string& asPSName,
          string& asPSFile,
          string& asEntity,
          bool abSavePS,
          float afR,
    ...
    static void __stdcall CreateEntityAtArea(string& asEntityName,
          string& asEntityFile,
          string& asAreaName,
          bool abFullGameSave,
          float afPosX,
    ...
    static void __stdcall AttachPropToBone(string& asChildEntityName,
    ...
    static void __stdcall AddAttachedPropToProp(string& asPropName,
          string& asAttachName,
          string& asAttachFile,
          float afPosX,
          float afPosY,
    ...
    // Parent can have asterix in name but mot child! Entity callbacks alStates = 1=only enter, -1=only leave 0=both. Syntax: void Func(string &in asParent, string &in asChild, int
    // alState). alState: 1=enter, -1=leave.
    ...
    // Entity connections
    static void __stdcall InteractConnectPropWithRope(string& asName,
          string& asPropName,
          string& asRopeName,
          bool abInteractOnly,
          float afSpeedMul,
     ...
     */
    static void __stdcall InteractConnectPropWithMoveObject(string& asName, string& asPropName, string& asMoveObjectName, bool abInteractOnly, bool abInvert, int alStatesUsed);
    /**
     * Callback Syntax: MyFunc(string &in asConnectionName, string &in asMainEntity, string &in asConnectEntity, int alState). State is what is sent to connection entity and will
     * be inverted if abInvertStateSent=true!
     */
