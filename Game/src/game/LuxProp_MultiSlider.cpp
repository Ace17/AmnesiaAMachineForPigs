...
cLuxPropLoader_MultiSlider::cLuxPropLoader_MultiSlider(const tString& asName)
...
cLuxProp_MultiSlider::cLuxProp_MultiSlider(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxProp(asName, alID, apMap, eLuxPropType_MultiSlider)
{
    mlCurrentState = -1;
    mlStuckState = -1;
