...
public:
    ...
    cLuxInventory_Item* AddItem(const tString& asName,
          eLuxItemType aType,
    ...
    void AddCombineCallback(const tString& asName, const tString& asItemA, const tString& asItemB, const tString& asFunction, bool abAutoDestroy);
...
private:
     ...
     */
    void DrawFrameAroundWidget(cGuiGfxElement** apGfxCorners,
          cGuiGfxElement** apGfxBorders,
          iWidget* apWidget,
          const cVector2f& avHPadding = 0,
          const cVector2f& avVPadding = 0,
     ...
     */
    void DrawFrame(cGuiGfxElement** apGfxFrameCorners, cGuiGfxElement** apGfxFrameBorders, const cVector3f& avPosition, const cVector2f& avSize);
