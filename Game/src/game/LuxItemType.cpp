...
cLuxItemType_Puzzle::cLuxItemType_Puzzle()
    : iLuxItemType("Puzzle", eLuxItemType_Puzzle)
{
}
...
cLuxItemType_Coins::cLuxItemType_Coins()
    : iLuxItemType("Coins", eLuxItemType_Coins)
{
}
...
cLuxItemType_Note::cLuxItemType_Note()
    : iLuxItemType("Note", eLuxItemType_Note)
{
...
cLuxItemType_Diary::cLuxItemType_Diary()
    : iLuxItemType("Diary", eLuxItemType_Diary)
{
    mbShowPickUpMessage = false;
}
...
cLuxItemType_Lantern::cLuxItemType_Lantern()
    : iLuxItemType("Lantern", eLuxItemType_Lantern)
{
}
...
cLuxItemType_Health::cLuxItemType_Health()
    : iLuxItemType("Health", eLuxItemType_Health)
{
    mbHasCount = true;
    mlMaxCount = 1;
}
...
cLuxItemType_Sanity::cLuxItemType_Sanity()
    : iLuxItemType("Sanity", eLuxItemType_Sanity)
{
    mbHasCount = true;
    mlMaxCount = 99;
}
...
cLuxItemType_Tinderbox::cLuxItemType_Tinderbox()
    : iLuxItemType("Tinderbox", eLuxItemType_Tinderbox)
{
    mbHasCount = true;
    mlMaxCount = 99;
}
...
cLuxItemType_HandObject::cLuxItemType_HandObject()
    : iLuxItemType("HandObject", eLuxItemType_HandObject)
{
}
