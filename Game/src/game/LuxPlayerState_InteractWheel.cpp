...
cLuxPlayerState_InteractWheel::cLuxPlayerState_InteractWheel(cLuxPlayer* apPlayer)
    : iLuxPlayerState_InteractRotateBase(apPlayer, eLuxPlayerState_InteractWheel)
{
    mRotatePid.p = 5.0f;
    mRotatePid.i = 0.0f;
    mRotatePid.d = 0.1f;
