...
cLuxScriptHandler::cLuxScriptHandler()
    : iLuxUpdateable("LuxScriptHandler")
{
...
#define BEGIN_SET_PROPERTY(aType, aSubType)                                                                                                                                        \
    ...
    if (GetEntities(asName, lstEntities, aType, aSubType) == false)                                                                                                                \
        return;                                                                                                                                                                    \
...
#define BEGIN_ITERATE_PARTICLESYSTEM()                                                                                                                                             \
    ...
    if (GetParticleSystems(asName, lstParticleSystems) == false)                                                                                                                   \
        return;                                                                                                                                                                    \
...
void cLuxScriptHandler::InitScriptFunctions()
{
    ...
    AddFunc("void CheckPoint(string &in asName,string &in asStartPos ,string &in asCallback, string &in asDeathHintCat, string &in asDeathHintEntry, bool abPlayerDark)",
          (void*)CheckPoint);
    ...
    AddFunc("void AddEffectVoice(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in asTextEntry, bool abUsePostion,  string &in asPosEnitity, float "
            "afMinDistance, float afMaxDistance)",
          (void*)AddEffectVoice);
    AddFunc("void AddEffectVoice(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in asTextEntry, bool abUsePostion,  string &in asPosEnitity, float "
            "afMinDistance, float afMaxDistance, int alPriority, bool abStopInterrupted)",
          (void*)AddEffectVoiceExt);

    AddFunc("void AddEffectVoice2(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in asTextEntry, float afTextDelay, string &in asText2Entry, float "
            "afText2Delay, bool abUsePostion,  string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
          (void*)AddEffectVoice2);
    AddFunc("void AddEffectVoice3(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in asTextEntry, float afTextDelay, string &in asText2Entry, float "
            "afText2Delay, string &in asText3Entry, float afText3Delay, bool abUsePostion,  string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
          (void*)AddEffectVoice3);
    AddFunc("void AddEffectVoice4(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in asTextEntry, float afTextDelay, string &in asText2Entry, float "
            "afText2Delay, string &in asText3Entry, float afText3Delay, string &in asText4Entry, float afText4Delay, bool abUsePostion, string &in asPosEnitity, float "
            "afMinDistance, float afMaxDistance)",
          (void*)AddEffectVoice4);
    AddFunc("void AddEffectVoice5(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in asTextEntry, float afTextDelay, string &in asText2Entry, float "
            "afText2Delay, string &in asText3Entry, float afText3Delay, string &in asText4Entry, float afText4Delay, string &in asText5Entry, float afText5Delay, bool "
            "abUsePostion, string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
          (void*)AddEffectVoice5);
    AddFunc("void AddEffectVoice6(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in asTextEntry, float afTextDelay, string &in asText2Entry, float "
            "afText2Delay, string &in asText3Entry, float afText3Delay, string &in asText4Entry, float afText4Delay, string &in asText5Entry, float afText5Delay, string &in "
            "asText6Entry, float afText6Delay, bool abUsePostion, string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
          (void*)AddEffectVoice6);
    AddFunc("void AddEffectVoice7(string &in asVoiceFile, string &in asEffectFile, string &in asTextCat, string &in asTextEntry, float afTextDelay, string &in asText2Entry, float "
            "afText2Delay, string &in asText3Entry, float afText3Delay, string &in asText4Entry, float afText4Delay, string &in asText5Entry, float afText5Delay, string &in "
            "asText6Entry, float afText6Delay, string &in asText7Entry, float afText7Delay, bool abUsePostion, string &in asPosEnitity, float afMinDistance, float afMaxDistance)",
    ...
    AddFunc("void ShowScreenImage(string &in asImageName, float afX, float afY, float afScale, bool abUseRelativeCoordinates, float afDuration, float afFadeIn, float afFadeOut)",
    ...
    AddFunc("void CreateParticleSystemAtEntityExt(	string &in asPSName, string &in asPSFile, string &in asEntity, bool abSavePS, float afR, float afG, float afB, float afA, "
    ...
    AddFunc("void PlaySoundAtPosition(string &in asSoundName, string &in asSoundFile, float afX, float afY, float afZ, float afFadeSpeed, bool abSaveSound)",
    ...
    AddFunc("void CreateEntityAtArea(string &in asEntityName, string &in asEntityFile, string &in asAreaName, bool abFullGameSave, float afPosX, float afPosY, float afPosZ, float "
            "afRotX, float afRotY, float afRotZ)",
    ...
    AddFunc("void RotatePropToSpeed(string &in asName, float afAcc, float afGoalSpeed, float afAxisX, float afAxisY, float afAxisZ, bool abResetSpeed, string &in asOffsetArea)",
          (void*)RotatePropToSpeed);
    AddFunc("void StopPropMovement(string &in asName)", (void*)StopPropMovement);

    AddFunc("void AttachPropToBone(string &in asChildEntityName, string &in asParentEntityName, string &in asParentBoneName, float fPosX, float fPosY, float fPosZ, float fRotX, "
            "float fRotY, float fRotZ)",
          (void*)AttachPropToBone);
    AddFunc("void DetachPropFromBone(string &in asChildEntityName)", (void*)DetachPropFromBone);

    AddFunc("void AddAttachedPropToProp(string &in asPropName, string &in asAttachName, string &in asAttachFile, float fPosX, float fPosY, float fPosZ, float fRotX, float fRotY, "
            "float fRotZ)",
    ...
    AddFunc("void AddEntityCollideCallback(string &in asParentName, string &in asChildName, string &in asFunction, bool abDeleteOnCollide, int alStates)",
    ...
    // AddFunc("void CreateRope(string &in asName,string &in asStartArea, string &in asEndArea, string &in asStartBody, string &in asEndBody,float afMinTotalLength, float
    // afMaxTotalLength,float afSegmentLength, float afDamping,float afStrength, float afStiffness, string &in asMaterial, float afRadius, float afLengthTileAmount, float
    // afLengthTileSize, string &in asSound,float afSoundStartSpeed, float afSoundStopSpeed,bool abAutoMove, float afAutoMoveAcc, float afAutoMoveMaxSpeed)",(void *)CreateRope);

    AddFunc("void InteractConnectPropWithRope(string &in asName, string &in asLeverName, string &in asPropName, bool abInteractOnly, float afSpeedMul,float afMinSpeed, float "
            "afMaxSpeed, bool abInvert, int alStatesUsed)",
          (void*)InteractConnectPropWithRope);
    AddFunc("void InteractConnectPropWithMoveObject(string &in asName, string &in asPropName, string &in asMoveObjectName, bool abInteractOnly,bool abInvert, int alStatesUsed)",
          (void*)InteractConnectPropWithMoveObject);
    AddFunc("void ConnectEntities(string &in asName, string &in asMainEntity, string &in asConnectEntity, bool abInvertStateSent, int alStatesUsed, string &in asCallbackFunc)",
...
void __stdcall cLuxScriptHandler::ShowScreenImage(string& asImageName,
      float afX,
      float afY,
      float afScale,
      bool abUseRelativeCoordinates,
      float afDuration,
      float afFadeIn,
      float afFadeOut)
{
...
void __stdcall cLuxScriptHandler::AddEffectVoice(string& asVoiceFile,
      string& asEffectFile,
      string& asTextCat,
      string& asTextEntry,
      bool abUsePostion,
...
void __stdcall cLuxScriptHandler::AddEffectVoice2(string& asVoiceFile,
      string& asEffectFile,
      string& asTextCat,
      string& asTextEntry,
      float afTextDelay,
      ...
      float afMaxDistance)
{
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, "", 0, "", 0, "", 0,
          "", 0, "", 0, abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice3(string& asVoiceFile,
      string& asEffectFile,
      string& asTextCat,
      string& asTextEntry,
      float afTextDelay,
      ...
      float afMaxDistance)
{
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
          afText3Delay, "", 0, "", 0, "", 0, "", 0, abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice4(string& asVoiceFile,
      string& asEffectFile,
      string& asTextCat,
      string& asTextEntry,
      float afTextDelay,
      ...
      float afMaxDistance)
{
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
          afText3Delay, asText4Entry, afText4Delay, "", 0, "", 0, "", 0, abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice5(string& asVoiceFile,
      string& asEffectFile,
      string& asTextCat,
      string& asTextEntry,
      float afTextDelay,
      ...
      float afMaxDistance)
{
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
          afText3Delay, asText4Entry, afText4Delay, asText5Entry, afText5Delay, "", 0, "", 0, abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice6(string& asVoiceFile,
      string& asEffectFile,
      string& asTextCat,
      string& asTextEntry,
      float afTextDelay,
      ...
      float afMaxDistance)
{
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
          afText3Delay, asText4Entry, afText4Delay, asText5Entry, afText5Delay, asText6Entry, afText6Delay, "", 0, abUsePostion, vPos, afMinDistance, afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoice7(string& asVoiceFile,
      string& asEffectFile,
      string& asTextCat,
      string& asTextEntry,
      float afTextDelay,
      ...
      float afMaxDistance)
{
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddMultiSubbedVoice(asVoiceFile, asEffectFile, asTextCat, asTextEntry, afTextDelay, asText2Entry, afText2Delay, asText3Entry,
          afText3Delay, asText4Entry, afText4Delay, asText5Entry, afText5Delay, asText6Entry, afText6Delay, asText7Entry, afText7Delay, abUsePostion, vPos, afMinDistance,
          afMaxDistance);
}

//-----------------------------------------------------------------------

void __stdcall cLuxScriptHandler::AddEffectVoiceExt(string& asVoiceFile,
      string& asEffectFile,
      string& asTextCat,
      string& asTextEntry,
      bool abUsePostion,
      ...
      bool abStopInterrupt)
{
    ...
    gpBase->mpEffectHandler->GetPlayVoice()->AddVoice(
          asVoiceFile, asEffectFile, asTextCat, asTextEntry, abUsePostion, vPos, afMinDistance, afMaxDistance, alPriority, abStopInterrupt);
}
...
void __stdcall cLuxScriptHandler::CreateParticleSystemAtEntityExt(string& asPSName,
      string& asPSFile,
      string& asEntity,
      bool abSavePS,
      float afR,
...
void __stdcall cLuxScriptHandler::FadeLightTo(string& asLightName, float afR, float afG, float afB, float afA, float afRadius, float afTime)
{
    ...
    cColor newColor(afR >= 0 ? afR : pLight->GetDiffuseColor().r, afG >= 0 ? afG : pLight->GetDiffuseColor().g, afB >= 0 ? afB : pLight->GetDiffuseColor().b,
...
static eLuxFocusCrosshair StringToCrossHair(const tString& asCrossHair)
{
    ...
    if (sLowCross == "voiceover")
        return eLuxFocusCrosshair_VoiceOver;
    if (sLowCross == "phonebox")
...
void __stdcall cLuxScriptHandler::CreateEntityAtArea(string& asEntityName,
      string& asEntityFile,
      string& asAreaName,
      bool abFullGameSave,
      float afPosX,
...
void __stdcall cLuxScriptHandler::RotatePropToSpeed(string& asName,
      float afAcc,
      float afGoalSpeed,
      float afAxisX,
      float afAxisY,
      ...
      string& asOffsetArea)
{
    ...
    if (pArea)
    {
        ...
        pProp->RotateAtSpeed(afAcc, afGoalSpeed, cVector3f(afAxisX, afAxisY, afAxisZ), abResetSpeed, true, pArea->GetPosition(), vLocalOffset);
    }
    else
    {
...
void __stdcall cLuxScriptHandler::AttachPropToBone(string& asChildEntityName,
      string& asParentEntityName,
      string& asParentBoneName,
      float fPosX,
      float fPosY,
      float fPosZ,
      float fRotX,
...
void __stdcall cLuxScriptHandler::AddAttachedPropToProp(string& asPropName,
      string& asAttachName,
      string& asAttachFile,
      float afPosX,
      float afPosY,
...
void __stdcall cLuxScriptHandler::ShowEnemyPlayerPosition(string& asName)
{
    ...
    if (state != eLuxEnemyState_Hunt && state != eLuxEnemyState_HuntPause && state != eLuxEnemyState_AttackMeleeLong && state != eLuxEnemyState_AttackMeleeShort &&
...
void __stdcall cLuxScriptHandler::InteractConnectPropWithRope(string& asName,
      string& asPropName,
      string& asRopeName,
      bool abInteractOnly,
      float afSpeedMul,
      ...
      int alStatesUsed)
{
    ...
    cLuxInteractConnection_Rope* pConnection = hplNew(
          cLuxInteractConnection_Rope, (asName, pProp, pRope, afSpeedMul, -cMath::Abs(afMinSpeed), cMath::Abs(afMaxSpeed), abInvert, alStatesUsed));
...
void __stdcall cLuxScriptHandler::InteractConnectPropWithMoveObject(string& asName,
      string& asPropName,
      string& asMoveObjectName,
      bool abInteractOnly,
      bool abInvert,
      int alStatesUsed)
{
