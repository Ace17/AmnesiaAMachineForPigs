...
cLuxAreaLoader_SlimeDamage::cLuxAreaLoader_SlimeDamage(const tString& asName)
...
cLuxArea_SlimeDamage::cLuxArea_SlimeDamage(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxArea(asName, alID, apMap, eLuxAreaType_SlimeDamage)
{
