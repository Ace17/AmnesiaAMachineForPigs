...
cLuxPlayerHands::cLuxPlayerHands(cLuxPlayer* apPlayer)
    : iLuxPlayerHelper(apPlayer, "LuxPlayerHands")
{
    ////////////////////
    // Init data
...
cLuxPlayerHandsLoader::cLuxPlayerHandsLoader(const tString& asName, cLuxPlayerHands* apPlayerHands)
