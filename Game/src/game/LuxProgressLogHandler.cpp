...
cLuxProgressLogHandler::cLuxProgressLogHandler()
    : iLuxUpdateable("LuxProgressLogHandler")
{
    mpFile = NULL;
    mlFileNameCount = 0;
    mlCounter = 0;
...
void cLuxProgressLogHandler::CreateAndResetLogFile()
{
    ...
    tWString sFileName = _W("ProgLog_") + gpBase->msProfileName + _W("_") + cString::ToStringW(currentDate.year, 4) + _W("_") + cString::ToStringW(currentDate.month + 1, 2) +
          _W("_") + cString::ToStringW(currentDate.month_day, 2) + _W("_") + cString::ToStringW(currentDate.hours, 2) + _W("_") + cString::ToStringW(currentDate.minutes, 2) +
          _W("_") + cString::ToStringW(currentDate.seconds, 2) + _W("_") + cString::ToStringW(mlFileNameCount, 2) + _W(".log");
...
void cLuxProgressLogHandler::AddLog(eLuxProgressLogLevel aLevel, const tString& asMessage)
{
    ...
    tString sInfection = cString::ToString(pPlayer->GetInfection(), 0);
    ...
    sFinalMess += " | " + sMapName + " | H:" + sHealth + " | S:" + sInfection + " | T:" + sTinderboxes + " | C:" + sCoins + " \n > ";
