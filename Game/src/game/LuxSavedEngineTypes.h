...
{
    kSerializableClassInit(cEngineCharacterBody_SaveData) public : void FromBody(iCharacterBody* apBody);
...
{
    kSerializableClassInit(cEngineVerletParticle_SaveData) public : void FromParticle(cVerletParticle* apPart);
...
{
    kSerializableClassInit(cEngineRope_SaveData) public : cRopeEntity* CreateRope(cLuxMap* apMap);
...
{
    kSerializableClassInit(cEngineBillboard_SaveData) public : void FromBillboard(cBillboard* apBillboard);
...
{
    kSerializableClassInit(cEngineAnimationState_SaveData) public : void FromAnim(cAnimationState* apAnim);
...
{
    kSerializableClassInit(cEngineSubMeshEntity_SaveData) public : void FromSubMeshEntity(cSubMeshEntity* apSubMeshEntity);
...
{
    kSerializableClassInit(cEngineMeshEntity_SaveData) public : void FromMeshEntity(cMeshEntity* apMeshEntity);
...
{
    kSerializableClassInit(cEngineBody_SaveData) public : void FromBody(iPhysicsBody* apBody);
...
{
    kSerializableClassInit(cEngineJoint_SaveData) public : void FromJoint(iPhysicsJoint* apJoint, iPhysicsWorld* apPhysicsWorld);
...
{
    kSerializableClassInit(cEnginePS_SaveData) public : void FromPS(cParticleSystem* apPS);
...
{
    kSerializableClassInit(cEngineLight_SaveData) public : void FromLight(iLight* apLight);
