...
cLuxAreaLoader_Ladder::cLuxAreaLoader_Ladder(const tString& asName)
...
cLuxArea_Ladder::cLuxArea_Ladder(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxArea(asName, alID, apMap, eLuxAreaType_Ladder)
{
