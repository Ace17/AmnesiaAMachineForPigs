...
cLuxPropLoader_OilBarrel::cLuxPropLoader_OilBarrel(const tString& asName)
...
cLuxProp_OilBarrel::cLuxProp_OilBarrel(const tString& asName, int alID, cLuxMap* apMap)
    : iLuxProp(asName, alID, apMap, eLuxPropType_OilBarrel)
{
